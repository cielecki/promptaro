...
@Test func requestedDefaults() {
    ...
    #expect(Prompt.defaults.map(\.text) == [
        "Note the possible paths forward and try to organize work in a way where you acquire sufficient information/decisions from me in order to work autonomously for an extended period of time.\n\nIn a final message only recommend the next logical step in this chat. ",
        "Proceed - this may be my approval, marking that I have done what you asked me for or an expectation you to do it for me; if you have any loose ends, tidy them up; in any case proceed with next logical step in this situation.",
